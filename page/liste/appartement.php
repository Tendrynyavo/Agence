<?php
    ...
    $apparts=getTypedHabitation("appartement");
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="container">
                ...
                <nav class="text-center navbar navbar-dark bg-dark">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="appartement.php">Appartement</a>
                        </li>
                    </ul>
                </nav>
            </div>
...
<!-- boucle -->     <?php foreach ($apparts as $appart) { ?>
                <a href="<?php echo $link_address;?>?idhabitation=<?php echo $appart->idhabitation; ?>" class="text-decoration-none">
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="../../img/<?php echo $appart->photoface ?>">

                            <div class="card-body">
                                <p class="card-text"><?php echo $appart->description ?></p>
